...
class ProductSummaryReportWizard(models.TransientModel):
    _name = "product.summary"
    _description = "Product Summary Report"
    ...
    def action_product_summary_print_report(self):
        domain = []
        ...
        return self.env.ref('dr_salim_custom_reports.action_product_summary_report').report_action(self, data=data)
